...
### Dimension: channel
| segment | segment_status | baseline_rate | current_rate | mix_effect | rate_effect | cross_term | total_effect | contribution_pct |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| paid_search | existing | 0.0730122 | 0.057987 | 0.00374848 | -0.00724257 | -0.000771402 | -0.00426549 | 52.2242 |
| organic | existing | 0.0676853 | 0.066806 | -0.00275829 | -0.000324791 | 3.58327e-05 | -0.00304725 | 37.3088 |
| email | existing | 0.0773542 | 0.0770947 | -0.000819084 | -3.85672e-05 | 2.74824e-06 | -0.000854903 | 10.467 |

### Dimension: device
| segment | segment_status | baseline_rate | current_rate | mix_effect | rate_effect | cross_term | total_effect | contribution_pct |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| mobile | existing | 0.0707175 | 0.0581937 | 0.00301446 | -0.00767385 | -0.000533847 | -0.00519323 | 63.583 |
| desktop | existing | 0.0732282 | 0.073655 | -0.00312149 | 0.000165279 | -1.8193e-05 | -0.00297441 | 36.417 |

### Dimension: city
| segment | segment_status | baseline_rate | current_rate | mix_effect | rate_effect | cross_term | total_effect | contribution_pct |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Bengaluru | existing | 0.0756096 | 0.0660837 | -0.000321055 | -0.00360847 | 4.04493e-05 | -0.00388908 | 47.6157 |
| Delhi | existing | 0.0686535 | 0.0598767 | -9.18793e-05 | -0.00261201 | 1.17461e-05 | -0.00269214 | 32.9611 |
| Mumbai | existing | 0.0698935 | 0.0638885 | 0.000390322 | -0.0019432 | -3.35354e-05 | -0.00158641 | 19.4232 |

### Dimension: category
| segment | segment_status | baseline_rate | current_rate | mix_effect | rate_effect | cross_term | total_effect | contribution_pct |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| skincare | existing | 0.0719581 | 0.0633273 | 7.83919e-05 | -0.00347484 | -9.4025e-06 | -0.00340585 | 41.6994 |
| baby | existing | 0.0762304 | 0.0679325 | -0.000118159 | -0.00269985 | 1.2862e-05 | -0.00280514 | 34.3446 |
| fitness | existing | 0.0658617 | 0.0585696 | 3.03372e-05 | -0.00198362 | -3.35884e-06 | -0.00195664 | 23.956 |
